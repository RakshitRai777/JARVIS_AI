...
A lightweight, multimodal AI assistant inspired by Iron Man’s JARVIS.  
This project integrates cutting-edge open-source models to provide text, image, and voice-based interactions — all running locally without dependency on external APIs.
